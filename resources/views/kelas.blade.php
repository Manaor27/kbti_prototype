  ...
  <div class="content-wrapper" style="background: url('https://static.vecteezy.com/system/resources/previews/005/178/913/original/white-and-light-gray-diagonal-line-architecture-geometry-tech-abstract-subtle-background-illustration-eps-10-vector.jpg'); background-size: cover;">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="regis">Pilih Matakuliah</a></li>
    ...
    <div class="content">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-3">
            <a href="regis" type="button" class="btn btn-default"><i class="fa fa-angle-left"></i></a>
          </div>
        </div>
        <br>
        <div class="row">
          <div class="col-md-4">
            <form action="simple-results.html">
              <div class="input-group">
                <input type="search" class="form-control" placeholder="Cari Matakuliah">
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td></td>
                      <td>
                        <a href="home" class="btn btn-primary">PILIH</a>
                      </td>
                    </tr>
                    <tr>
                      <td>xxx</td>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="home" class="btn btn-primary" onclick="return false;">PILIH</a>
                      </td>
                    </tr>
                  </tbody>
                </table>
