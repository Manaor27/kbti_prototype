  ...
  <div class="content-wrapper" style="background: url('https://static.vecteezy.com/system/resources/previews/005/178/913/original/white-and-light-gray-diagonal-line-architecture-geometry-tech-abstract-subtle-background-illustration-eps-10-vector.jpg'); background-size: cover;">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Pilih Matakuliah</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-3">
            <a href="home" type="button" class="btn btn-default"><i class="fa fa-angle-left"></i></a>
          </div>
        </div>
        <br>
        <div class="row">
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a href="kelas" class="btn btn-primary">PILIH</a>
                      </td>
                    </tr>
                    <tr>
                      <td>xxx</td>
